...
$.when(getStandings, getUsers).then(function(){
	var tableStart = `<table class="table table-hover" id="standings-table"><thead><tr><th scope="col">Name</th><th scope="col" id='week 1'>Week 10</th><th scope="col" id='week 2'>Week 11</th><th scope="col" id='week 3'>Week 12</th><th scope="col" id='week 4'>Week 13</th><th scope="col" id='week 5'>Week 14</th><th scope="col" class="active">Total</th><th scope="col" class="active">Percent</th></tr></thead><tbody>`;
